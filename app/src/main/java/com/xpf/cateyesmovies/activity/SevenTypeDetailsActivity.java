...
// 发现页面 feedType = 7 的详情页面
public class SevenTypeDetailsActivity extends Activity {
    ...
    private void initView() {
        String url = getIntent().getStringExtra("url"); // meituanmovie://www.meituan.com/forum/newsDetail?id=17118
        ...
        url = "http://m.maoyan.com/information/" + split[1].toString() + "?_v_=yes&share=Android";
